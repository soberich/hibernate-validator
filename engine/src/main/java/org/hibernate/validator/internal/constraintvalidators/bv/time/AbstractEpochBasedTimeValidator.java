...
public abstract class AbstractEpochBasedTimeValidator<C extends Annotation, T> implements HibernateConstraintValidator<C, T> {
	...
	public boolean isValid(T value, ConstraintValidatorContext context) {
		...
		int result = Long.compare( getEpochMillis( value, reference ), getAdjustedReferenceClock( reference ).millis() );
	...
	protected abstract Clock getAdjustedReferenceClock(Clock reference);
