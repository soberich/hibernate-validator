 ...
 * @author Marko Bekhta
 */
public class PropertyHolderValueContext<T, V> {
	 ...
	 */
	private final PropertyHolderMetaData currentPropertyHolderMetaData;
	...
	public static <T, V> PropertyHolderValueContext<T, V> getLocalExecutionContext(T value, PropertyHolderMetaData propertyHolderMetaData, PathImpl propertyPath) {
		@SuppressWarnings("unchecked")
		Class<T> rootBeanType = (Class<T>) value.getClass();
		return new PropertyHolderValueContext<>( value, rootBeanType, propertyHolderMetaData, propertyHolderMetaData, propertyPath );
	}

	private PropertyHolderValueContext(T currentBean, Class<T> currentBeanType, PropertyHolderMetaData propertyHolderMetaData, Validatable validatable, PathImpl propertyPath) {
		this.currentBean = currentBean;
		this.currentBeanType = currentBeanType;
		this.currentPropertyHolderMetaData = propertyHolderMetaData;
	...
	public final PropertyHolderMetaData getCurrentPropertyHolderMetaData() {
		return currentPropertyHolderMetaData;
	}
	...
	public final void appendNode(ConstraintLocation location) {
		PathImpl newPath = PathImpl.createCopy( propertyPath );
		location.appendTo( null, newPath );
		propertyPath = newPath;
	}
