...
import org.hibernate.validator.internal.metadata.descriptor.ClassLevelDescriptorImpl;
...
public class ClassLevelMetaData extends AbstractConstraintMetaData {
	...
	private ClassLevelMetaData(Class<?> beanClass,
	...
	@Override
	public ClassLevelDescriptorImpl asDescriptor(boolean defaultGroupSequenceRedefined, List<Class<?>> defaultGroupSequence) {
		return new ClassLevelDescriptorImpl(
				getType(),
	...
	public static class Builder extends MetaDataBuilder {
		...
		@Override
		public ClassLevelMetaData build() {
			return new ClassLevelMetaData(
					getBeanClass(),
