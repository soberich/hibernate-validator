 ...
 */
abstract class PropertyHolderConstraintMappingContextImplBase extends PropertyHolderConstraintContextImplBase {

	private final Set<ConfiguredConstraint<?>> constraints;

	PropertyHolderConstraintMappingContextImplBase(PropertyHolderConstraintMappingImpl mapping) {
		super( mapping );
