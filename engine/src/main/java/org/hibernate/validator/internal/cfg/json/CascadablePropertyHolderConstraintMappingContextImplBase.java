...
abstract class CascadablePropertyHolderConstraintMappingContextImplBase<C extends Cascadable<C>>
		extends PropertyHolderConstraintMappingContextImplBase implements Cascadable<C> {

	private final Type configuredType;
	protected boolean isCascading;
	protected final Map<Class<?>, Class<?>> groupConversions = newHashMap();

	CascadablePropertyHolderConstraintMappingContextImplBase(PropertyHolderConstraintMappingImpl mapping, Type configuredType) {
		super( mapping );
