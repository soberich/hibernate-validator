...
import org.hibernate.validator.internal.engine.PropertyHolderValueContext;
 ...
 * @author Marko Bekhta
 */
public class PropertyHolderValidationContext<T> implements ValidationContext<T> {
	...
	PropertyHolderValidationContext(
	...
	public void addConstraintFailure(ValueContext<?, ?> valueContext, ConstraintViolationCreationContext constraintViolationCreationContext, ConstraintDescriptor<?> descriptor) {
		...
		this.failingConstraintViolations.add(
				ConstraintViolationImpl.forPropertyHolderValidation(
						messageTemplate,
						constraintViolationCreationContext.getMessageParameters(),
						constraintViolationCreationContext.getExpressionVariables(),
						interpolatedMessage,
	...
	@Override
	public AbstractConstraintValidatorContext createConstraintValidatorContextFor(ConstraintDescriptorImpl<?> constraintDescriptor, PathImpl path) {
		return AbstractConstraintValidatorContext.simpleConstraintValidatorContext(
