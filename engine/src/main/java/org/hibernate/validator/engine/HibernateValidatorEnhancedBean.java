...
public interface HibernateValidatorEnhancedBean {
	 ...
	 *
	 * @return a value of a field named {@code name} of a current bean.
	 *
	 * @throws IllegalArgumentException in case when no field could be found for a given name.
	 */
	Object getFieldValue(String name);

	/**
	 * @param name the name of a getter property of interest.
	 *
	 * @return a value of a getter property named {@code name} of a current bean.
	 *
	 * @throws IllegalArgumentException in case when no getter property could be found for a given name.
	 */
